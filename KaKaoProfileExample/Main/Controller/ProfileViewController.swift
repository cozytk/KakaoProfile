...
//        button.translatesAutoresizingMaskIntoConstraints = false
    ...
    override func render() {
        ...
        dismissButton.snp.makeConstraints { make in
            ...
            make.leading.equalTo(view.safeAreaInsets).offset(10)
...
//
    ...
    func configProfile(info: Information) {
...
extension Reactive where Base: ProfileViewController {
    var configInfo: Binder<Information> {
        return Binder(self.base) { profileVC, info in
            self.base.configProfile(info: info)
        }
    }
}
